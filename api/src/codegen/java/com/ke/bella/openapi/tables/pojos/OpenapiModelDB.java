...
public class OpenapiModelDB implements Operator, Serializable {

    private static final long serialVersionUID = 1796467391;
    ...
    public OpenapiModelDB() {}

    public OpenapiModelDB(OpenapiModelDB value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("OpenapiModelDB (");
