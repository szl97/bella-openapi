...
public class OpenapiModelEndpointRelationDB implements Operator, Serializable {

    private static final long serialVersionUID = 1329639137;
    ...
    public OpenapiModelEndpointRelationDB() {}

    public OpenapiModelEndpointRelationDB(OpenapiModelEndpointRelationDB value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("OpenapiModelEndpointRelationDB (");
