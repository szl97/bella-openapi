...
- To understand detailed environment variable configuration and startup deployment details, please read: [Configuration Details](./configuration-details.md) and [Startup and Deployment Details](./startup-deployment-details.md)
...
```
Note: If you need to configure user login, see: [OAuth Configuration](./configuration-details.md#oauth-configuration)
...
For more detailed startup options and configuration instructions, please refer to [Startup and Deployment Details](./startup-deployment-details.md).
...
If you encounter MySQL or Redis container startup failures, it's usually due to data directory permission issues or system configuration. For detailed solutions, please refer to [Startup and Deployment Details](./startup-deployment-details.md#3-mysql-or-redis-container-fails-to-start).

## Related Documentation

- [Configuration Details](./configuration-details.md) - Detailed introduction to environment variable configuration, database configuration, cache configuration, Apollo configuration, and login service configuration
- [Startup and Deployment Details](./startup-deployment-details.md) - Detailed introduction to starting services, environment variable configuration, service management, and system initialization
